package za.co.tman.notification.service.messaging.googlepubsub.impl;
...
import za.co.tman.notification.config.PubSubMessagingProperties;
import za.co.tman.notification.enums.PubSubMessageType;
import za.co.tman.notification.service.messaging.IMMessageProcessor;
import za.co.tman.notification.service.messaging.googlepubsub.GooglePubSubHandler;
...
public class GooglePubSubHandlerImplTest {
    ...
    public void getSubscriptions() {
        ...
        List<String> targetSubscriptionNamesList = Arrays.asList("NotificationTopicSub", "NotificationGenericSub");
